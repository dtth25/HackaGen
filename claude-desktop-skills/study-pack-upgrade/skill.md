...
description: Upgrade AI Course Generator into a Document-to-Study-Pack app with Chroma, Study Guide PDF, slides, mindmap, quiz, flashcards, quality gate, and clean frontend UI.
...
- filter by user_id if auth exists
...
- Tài liệu của bạn được giữ riêng tư.
- Bạn có thể xóa tài liệu bất cứ lúc nào.
- Nội dung được tạo dựa trên nguồn trong file của bạn.
