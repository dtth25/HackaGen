...
- **AI**: OpenRouter-only, paid-only. Content generation và OCR gọi trực tiếp `google/gemini-2.5-pro`, retry đúng model này một lần khi provider/schema lỗi; frontend không biết nhà cung cấp.
